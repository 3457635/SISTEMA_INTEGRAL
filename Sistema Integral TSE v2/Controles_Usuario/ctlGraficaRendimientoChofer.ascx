<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlGraficaRendimientoChofer.ascx.vb" Inherits="Sistema_Integral_TSE_v45.ctlGraficaRendimientoChofer" %>
<p>
    &nbsp;</p>
<p>
    Año:<asp:TextBox ID="txbAno" runat="server"></asp:TextBox>
&nbsp;Mes:
    <asp:DropDownList ID="ddlMes" runat="server" Height="21px" Width="145px">
    </asp:DropDownList>
...
<p>
    Tamaño Gráfica:</p>
<p>
    Alto:<asp:TextBox ID="txbAlto" runat="server"></asp:TextBox>
</p>
<p>
    Ancho:<asp:TextBox ID="txbAncho" runat="server"></asp:TextBox>
    <asp:ImageButton ID="ibtnTamano" runat="server" />
</p>
<p>
    &nbsp;</p>
