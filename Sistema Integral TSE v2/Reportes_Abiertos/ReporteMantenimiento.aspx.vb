...
Public Class ReporteMantenimiento
    ...
    Dim Dpto As String = "Mantenimiento"
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (FileUpload1.HasFile) Then
            ...
            Else
                ...
                End Select
                If flag = 1 Then
                    FileUpload1.SaveAs(Server.MapPath("~/Reportes_Abiertos/Mantenimiento/" + nombre))
                    ...
                    End If
                Else
                    Label1.Text = "SOLO SE ADMITEN DOCUMENTOS TIPO PDF, WORD, EXCEL"
                End If
            End If
        End If
