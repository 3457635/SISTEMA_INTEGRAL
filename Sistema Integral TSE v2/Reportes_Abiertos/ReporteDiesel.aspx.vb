...
Public Class ReporteDiesel
    ...
    Dim Dpto As String = "Auditor_Diesel"
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (FileUpload1.HasFile) Then
            ...
            con.Open()
            cmd = New SqlCommand("Select count(*) from Archivos where nombre='" + nombre + "'", con)
            ...
            Else
                ...
                End Select
                If flag = 1 Then
                    FileUpload1.SaveAs(Server.MapPath("~/Reportes_Abiertos/Auditor_Diesel/" + nombre))
