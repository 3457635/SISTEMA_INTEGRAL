<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.master" CodeBehind="ReporteRH.aspx.vb" Inherits="Sistema_Integral_TSE_v45.ReporteRH" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    <asp:HyperLinkField DataNavigateUrlFields="Nombre" DataNavigateUrlFormatString="~\Reportes_Abiertos\RH\{0}" DataTextField="Nombre" HeaderText="Descargar" />
                </Columns>
