...
Partial Public Class Manejar_Roles
    ...
    Protected Sub AddUserToRoleButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles AddUserToRoleButton.Click
        ...
        If userInfo Is Nothing Then
            ActionStatus.Text = String.Format("The user {0} does not exist in the system.", UserNameToAddToRole.Text)
            Exit Sub
        End If

        ' Make sure that the user doesn't already belong to this role 
        If Roles.IsUserInRole(userToAddToRole, selectedRoleName) Then
            ActionStatus.Text = String.Format("User {0} already is a member of role {1}.", UserNameToAddToRole.Text, selectedRoleName)
            Exit Sub
        End If
        ...
        ' Display a status message 
        ActionStatus.Text = String.Format("User {0} was added to role {1}.", UserNameToAddToRole.Text, selectedRoleName)
        ' Refresh the "by user" interface 
        CheckRolesForSelectedUser()
