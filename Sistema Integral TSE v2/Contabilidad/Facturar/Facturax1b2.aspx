<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Facturax1b2.aspx.vb" Inherits="Sistema_Integral_TSE_v45.Facturax1b2" %>
            ...
            <tr>
                <td class="style12">
                    ...
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server">
                        <asp:ListItem Value="0">Mexicana</asp:ListItem>
                        <asp:ListItem Value="1">Americana</asp:ListItem>
                    </asp:RadioButtonList>
                    <br />
                    <br />
                    Viajes sin facturar:
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:tse-erpConnectionString2 %>" 
                ...
                &nbsp;<asp:LinkButton ID="lnkCancelarOrden" runat="server" Visible="False">Cancelar orden anterior.</asp:LinkButton>
                    ...
                    Generar factura<br /> <input id="btnConLineas" type="button" value="Mostrar Lineas" />
                    <input id="btnQuitarLineas" type="button" value="Quitar Lineas" />
                    <br />
...
WHERE empresas.id_empresa=@id_empresa and datediff(day,fechas.fecha,getdate())&lt;300 and fechas.tipo_fecha=1 AND (viajes.id_viaje NOT IN
            ...
            <tr>
                ...
                <td class="style11">
                    ...
                    <asp:TextBox ID="txbRelacion6" runat="server" Height="25px" SkinID="txbFactura" 
                        Width="44px" Visible="False"></asp:TextBox>
                    <asp:TextBox ID="txbIdViaje" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
