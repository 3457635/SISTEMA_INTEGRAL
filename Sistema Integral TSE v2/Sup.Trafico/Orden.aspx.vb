...
Public Class Orden
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'strURL = String.Format("http://tse-si.com/net2/evaluacionAbierta/OrdenMail.aspx?id_viaje={0}", id_viaje)
        ...
        Dim asunto = "Programacion de viaje " + lblOrden.Text

        'EnviarCorreo("auditoria@tse.com.mx", asunto, strResult)
